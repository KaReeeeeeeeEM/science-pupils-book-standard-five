# Science Pupil’s Book Standard Five — ADT Bundle Reference
...
**Science Pupil’s Book Standard Five** — This is an English-language primary science textbook from Tanzania, published by the Tanzania Institute of Education for Standard Five pupils, roughly equivalent to upper primary level. It covers a broad range of topics including the digestive and reproductive systems, growth and development in plants and animals, magnetism, and introductory computer coding with Scratch. The book uses a competency-based, activity-led approach with experiments, exercises, illustrations and practical tasks, emphasising health, everyday applications, observation, and independent as well as collaborative learning.
...
├── SCIENCE-STD-5-PB.db                    # SQLite database (pipeline state)
├── SCIENCE-STD-5-PB.pdf                   # Original source PDF
...
```json
{
  "title": "Science Pupil’s Book Standard Five",
  "bundleVersion": "1",
  "languages": {
    "available": [
      "en-GB"
...
| Original PDF | `SCIENCE-STD-5-PB.pdf` |
| Pipeline database | `SCIENCE-STD-5-PB.db` (SQLite) |
